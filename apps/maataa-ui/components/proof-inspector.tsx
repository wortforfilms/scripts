...
export function ProofInspector({ title, subtitle }: ProofInspectorProps) {
    ...
    <div className="min-h-screen bg-black p-6 text-white">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <label className="block text-sm text-white/70" htmlFor="hkd-file-input">Load HKD file</label>
          <input
            id="hkd-file-input"
            data-testid="hkd-file-input"
            type="file"
          ...
          <>
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <div
                  data-testid="hash-status"
                  className={`mt-4 inline-flex rounded-full px-3 py-1 text-xs ${status?.rootMatches ? "bg-emerald-500/10 text-emerald-300" : "bg-rose-500/10 text-rose-300"}`}
                >
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <div
                  ...
                  className={`mt-4 inline-flex rounded-full px-3 py-1 text-xs ${status?.signatureValid ? "bg-emerald-500/10 text-emerald-300" : "bg-yellow-500/10 text-yellow-300"}`}
                >
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <div className="mt-2 text-xs text-yellow-300/80" data-testid="traversal-status">
                {selectedIndex !== null
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <div className="space-y-2">
                {payload.map((event, index) => (
                  <button
                    key={index}
                    data-testid={`payload-leaf-${index}`}
